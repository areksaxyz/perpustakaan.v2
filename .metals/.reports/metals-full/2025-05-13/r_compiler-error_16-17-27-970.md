    ...
    public FinesPanel(DataStorage dataStorage) {
        ...
        tableModel = new DefaultTableModel(columnNames, 0) {
            ...
            public boolean isCellEditable(int row, int column) {
                return column == 5; // Kolom "Aksi" dapat diedit
            }
        };
        ...
        // Inisialisasi data denda
        updateTable();

        // Renderer dan Editor untuk kolom "Aksi"
        table.getColumnModel().getColumn(5).setCellRenderer(new FineActionRenderer());
        table.getColumnModel().getColumn(5).setCellEditor(new FineActionEditor(new JCheckBox(), dataStorage, tableModel));
    }
...
class FineActionEditor extends DefaultCellEditor {
    ...
    public FineActionEditor(JCheckBox checkBox, DataStorage dataStorage, DefaultTableModel tableModel) {
        super(checkBox);
        this.dataStorage = dataStorage;
