...
public class StatsPanel extends JPanel {
    ...
    public StatsPanel(DataStorage dataStorage) {
        ...
        // Bagian Riwayat Peminjaman (Tabel)
        String[] columnNames = {"ID Transaksi", "Nama Peminjam", "Judul Buku", "Tanggal Pinjam", "Tanggal Kembali", "Status"};
