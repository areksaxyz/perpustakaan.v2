...
public class LibraryUI extends JFrame {
    ...
    private void initializeUI() {
        ...
        JLabel titleLabel = new JLabel("📚 Perpustakaan Digital");
        ...
        JButton berandaButton = createSidebarButton("🏠 Beranda");
        ...
        berandaButton.addActionListener(e -> switchPanel("Beranda"));
    ...
    private void switchPanel(String panelName) {
        ...
        switch (panelName) {
            case "Beranda":
                currentPanel = new BerandaPanel(dataStorage);
                break;
            case "Katalog Buku":
