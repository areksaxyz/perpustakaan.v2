        ...
        if (isPushed) {
            ...
            if (row >= 0) {
                ...
                if (now.after(transaction.getDueDate()) && transaction.getReturnDate() == null) {
                    ...
                    dataStorage.getFines().add(transaction); // Asumsi DataStorage memiliki List<Transaction> fines
                    JOptionPane.showMessageDialog(null, "Transaksi ditambahkan ke Manajemen Denda.");
                } else {
