...
public class HomePanel extends JPanel {
    ...
    public HomePanel(DataStorage dataStorage) {
        ...
        JLabel leftImage = new JLabel(new ImageIcon("<WORKSPACE>/images/left_image.jpg"));
        ...
        JLabel rightImage = new JLabel(new ImageIcon("<WORKSPACE>/images/right_image.jpg"));
        rightImage.setHorizontalAlignment(JLabel.CENTER);
        imagePanel.add(rightImage);

        add(imagePanel, BorderLayout.CENTER);

        JPanel infoPanel = new JPanel(ne@@w GridLayout(3, 1, 10, 10));
