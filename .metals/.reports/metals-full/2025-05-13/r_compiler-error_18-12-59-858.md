...
public class LibraryUI extends JFrame {
    ...
    private void initializeUI() {
        ...
        navPanel.setBackground(new Color(52, 58, 64)); // #343A40
        navPanel.setPreferredSize(new Dimension(200, getHeight()));
        navPanel.setBorder(BorderFactory.createEmptyBorder(20, 10, 20, 10));

        // Tombol navigasi
        JButton homeButton = createNavButton("Beranda");
        ...
        JButton statsButton = createNavButton("Statistik");
        ...
        homeButton.addActionListener(e -> showPanel(new HomePanel(dataStorage)));
        ...
        statsButton.addActionListener(e -> showPanel(new StatisticsPanel(dataStorage)));

        // Tampilkan panel Beranda saat aplikasi dibuka
        showPanel(new HomePanel(dataStorage));
    }
    ...
    private JButton createNavButton(String text) {
        ...
        button.setBackground(new Color(52, 58, 64)); // #343A40
        ...
        button.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                button.setBackground(new Color(73, 80, 87)); // #495057
            }
